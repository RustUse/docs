...
<StatusWarning
  title="AI-readable routes"
  description="AI-readable routes help assistants find RustUse context. They do not make generated code authoritative. Verify code against Rustdocs and `cargo test`."
/>
