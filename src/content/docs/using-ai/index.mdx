...
import usingAI2d from '../../../assets/using-ai-2D.png';
import usingAI3d from '../../../assets/using-ai-3D.png';

<DocsMascotPanel
  image2d={usingAI2d}
  image3d={usingAI3d}
  alt="Ferris interacting with AI-readable RustUse documentation"
  eyebrow="Using AI"
  title="AI-Readable RustUse Documentation"
  description="AI-readable RustUse documentation surfaces for assistants, coding tools, and local agents."
  quickLinks={[
...
<StatusNote
  ...
  description="The LLM text files are generated from the same public RustUse documentation sources as the docs site."
/>
