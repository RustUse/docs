...
<MascotNote
  ...
  description="use-combinatorics is the discrete helper crate in the current RustUse math surface. Its public status is scaffolded, so RustUse-hosted generated rustdocs remain the canonical API reference while crates.io and docs.rs targets stay staged."
/>

<p>
  <StatusBadge status="scaffolded" /> Pre-1.0 checked-counting crate with
